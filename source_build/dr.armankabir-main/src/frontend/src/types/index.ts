...
export type LessonStatus = 'published' | 'unpublished' | 'free_preview';
export type LessonType = 'video' | 'text' | 'quiz' | 'resource';

export type QuizAttemptStatus = 'in_progress' | 'completed' | 'not_started';
...
export interface Resource {
  ...
  size_bytes: number;
  uploaded_by: number;
  upload_type: 'pdf' | 'image' | 'document' | 'video' | 'link';
  title?: string;
  description?: string;
